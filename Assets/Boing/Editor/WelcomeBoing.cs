...
namespace AppAdvisory.Hop
{
	...
	public class Welcome : EditorWindow 
	{
		...
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1DZ0aL-YLkUZvTucQYuHHpzKY_sab6FH8MAeWSTbLEx0/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/BmU";

		private const string NAME_OF_THE_GAME = "Boing";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
